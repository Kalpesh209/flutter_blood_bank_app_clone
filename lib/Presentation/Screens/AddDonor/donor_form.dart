...
class DonorFormScreen extends StatefulWidget {
  ...
  @override
  State<DonorFormScreen> createState() => _DonorFormState();
}

class _DonorFormState extends State<DonorFormScreen> {
              ...
              child: ElevatedButton(
                onPressed: () async {
                  if (_formKey.currentState!.validate() &&
                    ...
                    addDonorData['DonorAadharNumber'] =
                        _donorAadharCardNumber.text;
                    ...
                    addDonorData['WhoManyTimeDonate'] =
                        _whoManyTimeBloodDonate.text;
                    await _addItem();
                    // ignore: use_build_context_synchronously
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => const AddedDonorData()),
                    );
                  }
                },
  ...
  Future<void> _addItem() async {
    await SQLHelper.createItem(addDonorData);
    // _refreshPage();
  }
}
