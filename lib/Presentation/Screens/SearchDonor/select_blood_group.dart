...
import 'package:flutter_blood_bank_app_clone/Presentation/Screens/SearchDonor/selected_blood_group.dart';
            ...
            return InkWell(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => SelectedBloodGroupScreen(
                        bloodGroup: bloodGroup[index]['group']),
                  ),
                );
