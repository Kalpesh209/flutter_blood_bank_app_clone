...
import 'package:flutter_blood_bank_app_clone/Helper/sql_helper.dart';

class SelectedBloodGroupScreen extends StatefulWidget {
  final String bloodGroup;
  const SelectedBloodGroupScreen({super.key, required this.bloodGroup});

  @override
  State<SelectedBloodGroupScreen> createState() => _SelectedBloodGroupState();
}

class _SelectedBloodGroupState extends State<SelectedBloodGroupScreen> {
          ...
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                } else if (_donorData[index]['Group'] == 'A-' &&
                    widget.bloodGroup == 'A-') {
                  return Card(
                    child: ListTile(
                      leading: CircleAvatar(
                ...
                } else if (_donorData[index]['Group'] == 'B+' &&
                    widget.bloodGroup == 'B+') {
                  return Card(
                    child: ListTile(
                      leading: CircleAvatar(
                ...
                } else if (_donorData[index]['Group'] == 'AB+' &&
                    widget.bloodGroup == 'AB+') {
                  return Card(
                    child: ListTile(
                      leading: CircleAvatar(
                        child: Text(_donorData[index]['Group']),
                ...
                } else if (_donorData[index]['Group'] == 'O+' &&
                    widget.bloodGroup == 'O+') {
                  return Card(
                    child: ListTile(
                      leading: CircleAvatar(
